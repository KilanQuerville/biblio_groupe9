...
<html>
    <head>
        <metacharset="utf-8">
        <link rel="stylesheet" href="biblio/tome3.css">
        <body>
<?php
            require "tome3.html"
            <a href="Index.html">
