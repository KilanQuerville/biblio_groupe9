...
?>
    ...
    <?php
        ...
        $req = " SELECT * FROM `livre`   JOIN editeur ON  livre.isbn= 9782070584628 AND livre.editeur=editeur.id JOIN genre ON livre.isbn=9782070584628 AND livre.genre=genre.id   ;";
